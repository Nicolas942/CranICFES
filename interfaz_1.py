...
# Rectángulos para los botones (posiciones base)
pos_ajustes = (220, 580)
...
while corriendo:
    ...
    # Dibujar según la pantalla actual
    if pantalla_actual == "menu":
        ventana.fill(Celeste)
        mouse_pos = pygame.mouse.get_pos()

        # Botón AJUSTES con efecto hover
        if rect_ajustes.collidepoint(mouse_pos):
        ...
        ventana.fill((200, 200, 255))  # Fondo diferente
        ...
        ventana.fill((255, 255, 200))  
        font = pygame.font.SysFont(None, 60)
        texto = font.render("creditos", True, negro)
        ventana.blit(texto, (ancho // 2 - texto.get_width() // 2, alto // 2 - 30))
